...
public class StudentTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("stu1.count : " + stu1.count);
		Student.serialNum++; // 1
		stu1.count++;
		...
		System.out.println("stu2.count : " + stu2.count);
		Student.serialNum++; // 2
		stu2.count++;
		...
		System.out.println("stu3.count : " + stu3.count);
		Student.serialNum++; // 3
		stu3.count++;
		...
		System.out.println("stu4.count : " + stu4.count);
		stu4.count++;
